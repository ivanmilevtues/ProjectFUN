...
$(function() {
    $.each(['#f00', '#ff0', '#0f0', '#0ff', '#00f', '#f0f', '#000', '#fff'], function() {
      $('#colors_demo .tools').append("<a href='#simple_sketch' data-color='" + this + "' style='width: 10px; background: " + this + ";'></a> ");
    });
    $.each([3, 5, 10, 15], function() {
      $('#colors_demo .tools').append("<a href='#simple_sketch' data-size='" + this + "' style='background: #ccc'>" + this + "</a> ");
    });
...
function sendPicture() {
    try {
        ...
        window.location.href = "/result_room";
    }
} 
